-- Active: 1749606776741@@127.0.0.1@3306@stargram
/*
6. 관계 만들기
6.1 관계란
*/
...
CREATE TABLE users (
  ...
  email VARCHAR(255) UNIQUE, -- 이메일(중복X)
  PRIMARY KEY (id) -- 기본키 지정: id
);
